...
public class UserAddressController {
    ...
    @PostMapping
    public ResponseEntity<UserAddressDTO> saveUserAddress(@RequestBody UserAddressEntity userAddress){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserAddressDTO> updateUserAddress(@PathVariable int id, @RequestBody UserAddressEntity userAddress){
