...
public class RoleController {
    private final RoleDTO.RoleService service;
    ...
    @PostMapping
    public ResponseEntity<RoleDTO> saveRole(@RequestBody RoleEntity role){
    ...
    @PutMapping("/{name}")
    public ResponseEntity<RoleDTO> updateRole(@PathVariable String name, @RequestBody RoleEntity role){
