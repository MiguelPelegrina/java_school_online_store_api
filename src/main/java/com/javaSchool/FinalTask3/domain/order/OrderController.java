...
public class OrderController {
    ...
    @PostMapping
    public ResponseEntity<OrderDTO> saveOrder(@RequestBody OrderEntity order){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<OrderDTO> updateOrder(@PathVariable int id, @RequestBody OrderEntity order){
