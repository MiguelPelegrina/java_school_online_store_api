 ...
 * {@link OrderBookRestControllerImpl}. Obtains data from the
 * {@link OrderBookRepository} and returns the object(s) of the entity {@link OrderBookEntity} as
 * {@link OrderBookDTO} to the {@link OrderBookRestControllerImpl}.
 */
@Service
@Transactional(readOnly = true)
public class OrderBookServiceImpl extends AbstractServiceImpl<OrderBookEntity, OrderBookDTO, OrderBookId> {
    /**
