...
public class CityController {
    ...
    @PostMapping
    public ResponseEntity<CityDTO> saveCity(@RequestBody CityEntity city){
    ...
    @PutMapping("/{name}")
    public ResponseEntity<CityDTO> updateCity(@PathVariable String name, @RequestBody CityEntity city){
